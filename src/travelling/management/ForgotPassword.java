...
public class ForgotPassword extends JFrame implements ActionListener{
	...
	JLabel l1 = new JLabel("Nijer Nam ta mone ache to?");
	l1.setFont(new Font("Tahoma", Font.BOLD, 13));
	l1.setBounds(80, 83, 195, 21);
	contentPane.add(l1);

	JLabel l2 = new JLabel("MAGI NAME");
	l2.setFont(new Font("Tahoma", Font.BOLD, 13));
	l2.setBounds(80, 122, 187, 29);
	contentPane.add(l2);

	JLabel l3 = new JLabel("Your Security Question");
	l3.setFont(new Font("Tahoma", Font.BOLD, 13));
	l3.setBounds(80, 154, 156, 27);
	contentPane.add(l3);
 ...
 t3.addMouseListener(new MouseAdapter() {
	...
	contentPane.add(t5);
        ...
        ImageIcon c1 = new ImageIcon(ClassLoader.getSystemResource("icons/animation.gif"));
        Image i1 = c1.getImage().getScaledInstance(180, 200,Image.SCALE_DEFAULT);
	...
	b2 = new JButton("2.Bhogoban k Dako");
	b2.addActionListener(this);
	b2.setFont(new Font("Tahoma", Font.BOLD, 12));
	b2.setBounds(426, 188, 150, 29);
