...
public class Loading extends JFrame implements Runnable {
	...
	public Loading(String username) {
            ...
            setBounds(450, 100, 601, 400);
            contentPane = new JPanel();
            contentPane.setBackground(new Color(51,204, 255));
            setContentPane(contentPane);
            contentPane.setLayout(null);

            JLabel lbllibraryManagement = new JLabel("Welcome To Underworld of MAGI_CLUB");
            lbllibraryManagement.setForeground(new Color(72, 209, 204));
            lbllibraryManagement.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            lbllibraryManagement.setBounds(23, 46, 700, 35);
            ...
            JLabel lblNewLabel_2 = new JLabel("Darao Botso....");
